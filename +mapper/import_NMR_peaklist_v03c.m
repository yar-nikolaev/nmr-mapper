function assign = import_NMR_peaklist_v03c(peaklist_filepath, prot_seq_filepath)
...
% import_NMR_peaklist_v03c - combines/fixes v03+v03b checks: if there are
% any header lines or lines with peak names (contains peak names (#...
% lines)).
...
peaklist_filepath = fullfile('/Volumes/Data/yar/Dropbox/Science/Projects/2015_NMR_peak_tracking/site_mapper/190321_PR1_SLH_C11/analysis/data_test/PR1_header_and_peaknames.peaks');
% peaklist_filepath = fullfile('/Volumes/Data/yar/Dropbox/Science/Projects/2015_NMR_peak_tracking/site_mapper/190321_PR1_SLH_C11/analysis/data_test/PR1_no_header_no_peaknames.peaks');
% peaklist_filepath = fullfile('/Volumes/Data/yar/Dropbox/Science/Projects/2015_NMR_peak_tracking/site_mapper/190321_PR1_SLH_C11/analysis/data_test/PR1_header_no_peaknames.peaks');
...
c = c{1};
peaklist_has_header_lines = strcmp(c{1}(1),'#');

if peaklist_has_header_lines    
    while strcmp(c{1}(1),'#') % while there are extra header lines - remove them
        c = c(2:end);
    end;
end;

% Check if 2nd line has HASH-sign, means peaklist has peaknames:
peaklist_has_peaknames = strcmp(c{2}(1),'#');
    
if peaklist_has_peaknames
    n_peaks = size(c,1)/2;
