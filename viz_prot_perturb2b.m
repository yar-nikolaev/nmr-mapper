...
% viz_prot_perturb2b:
%   - quick-n-dirty - added code to import data from CARA repo. (once it
%   imports in exactly same "assign" structure - can convert to viz_prot_perturb3
...
flag_drop_first_point = 1; % to count CSP from second spectrum. 
